  ...
  class UISchemaFactory {
    ...
    async updateSchemaWithEnums(
      ...
      const fieldMapping = {
        ...
        guardian_nature_of_business: "business_type",
        guardian_business_type: "business_type",
        guardian_other_business_type: "other_business_type",
      };
    ...
    async initializeSchema(setJsonSchema, formData) {
      ...
      const fieldsToUpdate = [
        ...
        "guardian_nature_of_business",
        "guardian_business_type",
        "guardian_source_of_income",
        "guardian_other_business_type",
      ];
    ...
    async updateFormAndSchema(formData, schemaConditions) {
      ...
      if (this.formData?.case_status !== "case-init") {
        this.setJsonSchema((prevSchema) => {
          if (!prevSchema) return prevSchema;
          return {
            ...prevSchema,
      ...
      } else if (this.formData?.case_status === "case-review") {
        this.setJsonSchema((prevSchema) => ({
          ...prevSchema,
          hasStep: false,
        }));
