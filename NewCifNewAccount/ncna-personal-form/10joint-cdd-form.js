  ...
  class UISchemaFactory {
    ...
    async initializeSchema(setJsonSchema, formData) {
      ...
      if (
        ...
        this.setNextStep("joint-ecdd-form");
    ...
    async updateFormAndSchema(formData, schemaConditions) {
      ...
      if (
        ...
        this.setNextStep("joint-documents");
      }
      let disableButton;
      this.setJsonSchema((prevJson) => {
        const requiredFields = prevJson.required || [];

        const allFilled = requiredFields.every((field) => {
          const value = formData?.[field];
          return value !== undefined && value !== null && value !== "";
        });
        disableButton = !allFilled;
        return prevJson;
      });

      this.setUiSchema((prevUiSchema) => {
        console.log(prevUiSchema);
        return {
          ...prevUiSchema,

          calculate_risk: {
            ...prevUiSchema.calculate_risk,
            "ui:disabled": disableButton,
          },
        };
      });
