    ...
    async calculateRisk(value) {
      ...
      try {
        ...
        if (response) {
          ...
          if (resp?.message?.includes("Payload required")) {
            ...
            resp?.risk_level.includes("High Risk")
              ? this.setNextStep("corporate-ecdd-form")
              : this.setNextStep("corporate-documents");
          }
        }
